...
global_waters<-vect("C:/Users/cleme/Eagle/active_remote_sensing/water_bodies/World_Seas_IHO_v3/World_Seas_IHO_v3/World_Seas_IHO_v3.shp")
plot(global_waters)
...
poly <- project(global_waters, rectified_raster)

masked_raster <- mask(rectified_raster, global_waters)
cropped_raster <- crop(rectified_raster, global_waters)
...
max_filter <- focal(l1_s1raster, w, fun = max, na.rm = TRUE)
plot(max_filter)
